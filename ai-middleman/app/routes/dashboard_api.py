"""
dashboard_api.py — read endpoints backing the React dashboard (ai-middleman/frontend).

All queries mirror what dashboard/app.py (the Streamlit dashboard) already
runs against the `contacts` table, just exposed as JSON for the web frontend.
"""
